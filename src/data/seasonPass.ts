...
export const SEASON_PASS_1: SeasonPass = {
  ...
  quests: [
    ...
    },
    {
      id: 'quest8',
      title: 'Supply Chain',
      description: 'Use an airdrop crate',
      xpReward: 25,
      completed: false,
    },
    {
    ...
    },
    {
      ...
      description: 'Stay outside of buildings for 5 minutes in a match',
      xpReward: 30,
      completed: false,
    },
    {
    ...
    },
    {
      id: 'quest13',
      title: 'Crate Hoarder',
      description: 'Open 5 gold crates in a single match',
      xpReward: 45,
      completed: false,
    },
    {
    ...
    },
    {
      id: 'quest18',
      title: 'Quick Draw',
      description: 'Eliminate a player within 5 seconds of landing',
      xpReward: 30,
      completed: false,
    },
  ]
